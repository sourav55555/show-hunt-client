        ...
        <div className="font-2 w-[90%] md:w-[1100px] mx-auto py-8 md:py-16 rounded-xl mb-36 px-4 md:px-20 bg-[var(--e)] relative z-30 ">
            ...
            <div className="mt-8 flex items-center justify-center flex-col md:flex-row gap-6 px-10">
                <div className="relative group">
                    ...
                    <img src="/public/category/OIG2.jpg" alt="" className="object-cover rounded-lg" />
                ...
                <div className="relative group">
                    <div className="category-bg absolute top-0 left-0 z-10 h-full w-full rounded-lg"></div>
                    <img src="/public/category/OIG5.jpg" alt="" className="object-cover rounded-lg" />
                ...
                <div className="relative group">
                    <div className="category-bg absolute top-0 left-0 z-10 h-full w-full rounded-lg"></div>
                    <img src="/public/category/OIG3.jpg" alt="" className="object-cover rounded-lg" />
                ...
                <div className="relative group">
                    <div className="category-bg absolute top-0 left-0 z-10 h-full w-full rounded-lg"></div>
                    <img src="/public/category/OIG4.jpg" alt="" className="object-cover rounded-lg" />
